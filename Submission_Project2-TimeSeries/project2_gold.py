...
Original file is located at
    https://colab.research.google.com/drive/1rbS-H_UnItzdpSN4dBXWVMTrKuZ4Nj5u
"""
...
threshold_mae = (new_df['Change %'].max() - new_df['Change %'].min()) * 10/100
print(threshold_mae)
